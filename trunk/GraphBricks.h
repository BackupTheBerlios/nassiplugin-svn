...
public:
    ...
    virtual bool IsOverChild(const wxPoint &pos, wxRect *childRect = NULL, wxUint32 *childNumber = NULL);
    NassiBrick *GetBrick(){ return m_brick; }

    virtual bool IsOverChildIndicator(const wxPoint & pos, wxUint32 *childNumber = NULL){return false;}
...
public:
    ...
    virtual bool IsOverChild(const wxPoint &pos, wxRect *childRect = NULL, wxUint32 *childNumber = NULL) = 0;
    virtual HooverDrawlet *GetDrawlet(const wxPoint &pos, bool HasNoBricks = false);
    virtual GraphNassiBrick::Position GetPosition(const wxPoint &pos);
private:
    bool m_minimized;
...
class GraphNassiSwitchBrick : public GraphNassiMinimizableBrick
{
    ...
    public:
        ...
        virtual bool IsOverChildIndicator(const wxPoint & pos, wxUint32 *childNumber = NULL);
